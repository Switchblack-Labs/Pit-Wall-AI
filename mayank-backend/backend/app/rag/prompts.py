...
# Deterministic phrase the model must emit when the context does not contain
# the answer. Used by the pipeline to flag ungrounded responses.
NOT_IN_REGULATIONS = (
...
# User-side prompt carrying the retrieved context and the question.
RAG_USER_PROMPT = (
...
# --- Backward-compatible single-shot template (kept for existing callers) ---
RAG_PROMPT = """
